...
build() {
  curl https://raw.github.com/Floft/Flotografy/master/$pkgname -so $srcdir/$pkgname
  curl https://raw.github.com/Floft/Flotografy/master/${pkgname}_dirs -so $srcdir/${pkgname}_dirs
  curl https://raw.github.com/Floft/Flotografy/master/${pkgname}_farm -so $srcdir/${pkgname}_farm
  curl https://raw.github.com/Floft/Flotografy/master/${pkgname}_farm.daemon -so $srcdir/${pkgname}_farm.daemon
